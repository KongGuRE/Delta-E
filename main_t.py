...
if __name__ == '__main__':
    ...
    for data_1_path_Image_name in tqdm(data_1_path_img_files):
        for data_2_path_Image_name in data_2_path_img_files:
            ...
            # data_2_path_Image_name = data_2_path_Image_name.rstrip('.jpg') + "_700001" + ".png"

            if data_1_file_name == data_2_file_name:
